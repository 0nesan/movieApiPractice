...
var Main = {
  ...
  mainRender: function mainRender() {
    ...
    Main.app.innerHTML = "\n        ".concat(_header.Header.headerInner, "\n        <div class=\"bg-box\">\n            <div class=\"bg-img\"> </div>\n        </div>\n        ");
  }
};
exports.Main = Main;
},{"./header.js":"js/components/header.js"}],"js/apikeys.js":[function(require,module,exports) {
"use strict";
...
var _default = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(movieName, movieType, movieYear, nums, movieId, getMovieTitle) {
    var url, apikey, title, getTitle, type, page, year, id, plot, response, data, pathname;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            apikey = "?apikey=".concat(_apikeys.apiKey, "&");
            title = "s=".concat(movieName, ";");
            getTitle = "&t=".concat(getMovieTitle, ";");
            type = "&type=".concat(movieType);
            page = "&page=".concat(nums);
            year = "&y=".concat(movieYear);
            id = "&i=".concat(movieId);
            plot = "&plot=full";
            pathname = window.location.pathname;
            _context.t0 = pathname;
            _context.next = _context.t0 === '/search' ? 14 : _context.t0 === '/movie' ? 21 : 28;
            break;
          case 14:
            _context.next = 16;
            return fetch("".concat(url + apikey + title + type + year + page));
          case 16:
          ...
          case 21:
            _context.next = 23;
            return fetch("".concat(url + apikey + id + getTitle + plot));
          case 23:
            response = _context.sent;
            _context.next = 26;
            return response.json();
...
},{"./apikeys.js":"js/apikeys.js","./components/main":"js/components/main.js"}],"js/loading.js":[function(require,module,exports) {
"use strict";
...
var Loading = /*#__PURE__*/function () {
  function Loading(options) {
    ...
    var _options$el = options.el,
      element = _options$el === void 0 ? null : _options$el;
...
exports.getTitleVal = exports.getIdVal = exports.Search = void 0;
...
// 영화 아이디,이름값
var getIdVal = '';
exports.getIdVal = getIdVal;
var getTitleVal = '';
exports.getTitleVal = getTitleVal;
var Search = {
  ...
  searchRender: function searchRender() {
    _main.Main.app.innerHTML = Search.searchInner;
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _movieListWrap = document.querySelector('.movieListWrap');
                _context.next = 4;
                return (0, _getdata.default)(titleVal, typeVal, yearsVal, numsVal);
              case 4:
                data = _context.sent;
                dataInfo = data.Search;
                if (!(dataInfo === undefined && numsVal > 1)) {
                  _context.next = 8;
                  break;
                }
    ...
    var titleVal,
      ...
      yearsVal,
      movieListWrap = '';
    var valueSetting = function valueSetting() {
    ...
    var type = '',
      ...
      nums = '';
    // 로딩 생성
    var loader = new _loading.default({
      el: ".loading"
    });
    var renderEvent = /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e, scroll) {
        var num, i, movieList;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 9:
                ...
                num++;
                _context2.next = 13;
                return searchData(titleVal, typeVal, yearsVal, num);
              case 13:
                i--;
                _context2.next = 9;
                break;
              ...
              case 18:
                _context2.next = 20;
                return searchData(titleVal, typeVal, yearsVal, scroll);
              case 20:
                //로딩 종료
                loader.stop();
              case 21:
      ...
      return function renderEvent(_x5, _x6) {
        return _ref2.apply(this, arguments);
      };
    }();

    // 아이디,타이틀 가져오기
    var idPush = function idPush(e) {
      exports.getIdVal = getIdVal = e.target.getAttribute('movieid');
      exports.getTitleVal = getTitleVal = e.target.getAttribute('movietitle');
    };
...
},{"./main.js":"js/components/main.js","../getdata.js":"js/getdata.js","../loading.js":"js/loading.js","../app":"js/app.js"}],"js/components/movies.js":[function(require,module,exports) {
"use strict";
...
var Movies = {
  ...
  mainRender: function mainRender() {
    _main.Main.app.innerHTML = Movies.movieInner;
    var movieWrap = document.querySelector('.movie-wrap');
    var loader = new _loading.default({
      el: ".loading"
    });
    var movieData = /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var data, ratings, movieInfo;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
              ...
              case 4:
                ...
                ratings = function ratings() {
                  ...
                  for (var i = 0; i < source.length; i++) {
                    ...
                    ratings += "\n                            <div class=\"rating-wrap\">\n                                <img src='".concat(image, "' alt='").concat(source[i], "'>\n                                <span>").concat(value[i], "</span>\n                            </div>\n                        ");
                  }
                  return ratings;
                };
...
},{"./main.js":"js/components/main.js","../getdata.js":"js/getdata.js","./search.js":"js/components/search.js","../loading.js":"js/loading.js"}],"js/app.js":[function(require,module,exports) {
"use strict";
...
var removeScrollEl = function removeScrollEl() {
...
var menuEventListener = function menuEventListener() {
  ...
  menuList.forEach(function (e) {
    ...
    if ("/".concat(e.innerText.toLowerCase()) === pathname) e.classList.add('click');
...
// 초기 랜더
renderContents();
},{"./components/main.js":"js/components/main.js","./components/search.js":"js/components/search.js","./components/header.js":"js/components/header.js","./components/movies.js":"js/components/movies.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
