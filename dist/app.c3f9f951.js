...
},{"./apikeys.js":"js/apikeys.js","./components/main":"js/components/main.js"}],"js/components/search.js":[function(require,module,exports) {
"use strict";
...
var Search = {
  ...
  searchRender: function searchRender() {
    ...
    var renderEvent = function renderEvent() {
      var titleVal = document.querySelector('.movie-title').value;
      var typeVal = document.querySelector('.type').value;
      var numsVal = Number(document.querySelector('.nums').value);
      var yearsVal = document.querySelector('.years').value;
      var movieListWrap = document.querySelector('.movieListWrap');
      movieListWrap.innerHTML = '';
      for (var i = numsVal; i > 0; i--) {
...
},{"./main.js":"js/components/main.js","../getdata.js":"js/getdata.js"}],"js/app.js":[function(require,module,exports) {
"use strict";
...
// 초기 랜더
renderContents();
},{"./components/main.js":"js/components/main.js","./components/search.js":"js/components/search.js","./components/header.js":"js/components/header.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
