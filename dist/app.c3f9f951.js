...
exports.Main = Main;
},{"./header":"js/components/header.js"}],"js/apikeys.js":[function(require,module,exports) {
"use strict";
...
exports.searchVal = exports.getMovies = void 0;
var _apikeys = require("./apikeys");
var _main = require("./components/main");
var searchVal;
exports.searchVal = searchVal;
var getMovies = function getMovies(movieName, type, nums) {
  return new Promise(function (resolve) {
    if (nums === 10) {
      fetch("https://www.omdbapi.com/?apikey=".concat(_apikeys.apiKey, "=").concat(movieName, "&type=").concat(type)).then(function (res) {
        return res.json();
      }).then(function (res) {
        ...
        switch (pathname) {
          case '/search':
            ...
            try {
              var data = res.Search.map(function (e) {
      ...
      fetch("https://www.omdbapi.com/?apikey=".concat(_apikeys.apiKey, "=").concat(movieName, "&type=").concat(type, "&page=2")).then(function (res) {
        return res.json();
      }).then(function (res) {
        var pathname = window.location.pathname;
        switch (pathname) {
...
},{"./apikeys":"js/apikeys.js","./components/main":"js/components/main.js"}],"js/components/search.js":[function(require,module,exports) {
"use strict";
  ...
  searchRender: function searchRender() {
    ...
    var searchData = /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var titleVal, typeVal, numsVal, yearsVal;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                titleVal = document.querySelector('.movieTitle').value;
                typeVal = document.querySelector('.type').value;
                numsVal = document.querySelector('.nums').value;
                yearsVal = document.querySelector('.years').value;
                _context.next = 6;
                return (0, _getdata.getMovies)(titleVal, typeVal, numsVal);
              case 6:
              case "end":
...
},{"./main.js":"js/components/main.js","../getdata":"js/getdata.js"}],"js/app.js":[function(require,module,exports) {
"use strict";
